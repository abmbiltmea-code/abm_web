...
export const sectionHeaderData = {
  ...
  title: "Diverse Sectors Driven by Engineering Excellence",
  description:
    "Delivering specialized engineering and construction solutions across diverse industries with a strong focus on quality, efficiency, and long-term value.",
};

export const projectSectorsData = [
  {
    title: "Residential",
    description:
