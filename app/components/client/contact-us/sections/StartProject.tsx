      ...
      <div className="container">
        <div className="flex flex-col lg:flex-row justify-between gap-40 lg:gap-100 xl:gap-120 3xl:gap-140 items-start">
          <div className="w-full lg:w-[40%] 3xl:max-w-[560px]">
            <SectionTitle title="Start Your Project With Us" className="mb-[30px] lg:mb-5" />
            <SectionDescription className="text-description-color" text="Fill out the form to send us a message." />
          </div>
