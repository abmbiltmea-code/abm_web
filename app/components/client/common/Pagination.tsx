...
//   const boxBase =
//     "flex items-center justify-center w-12 h-12 3xl:w-15 3xl:h-15 rounded-[5px] border transition-colors duration-300 cursor-pointer";
...
//             <span
//               key={`ellipsis-${i}`}
//               className="flex items-center justify-center w-12 h-12 3xl:w-15 3xl:h-15 text-description-2 cursor-default select-none"
//             >
//               ···
//             </span>
//           );
...
const SCROLL_DURATION = 1.2; // seconds, matches scrollTo({ duration })
