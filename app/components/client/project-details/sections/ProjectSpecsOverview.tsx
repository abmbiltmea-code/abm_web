...
//             >
//               <p className="text-description-color text-15 leading-[1.6666667] mb-[10px] md:mb-[5px] uppercase">
//                 {specLabels[key]}
//               </p>
...
//         <SectionSubtitle
//           text="Scope of Work"
//           className="mt-5 sm:mt-60 mb-5 !text-subtitle-3"
//         />

//         <div className="flex flex-wrap gap-y-[10px] md:gap-y-[10px] gap-x-[10px] md:gap-x-[18px]">
//           {scopeOfWork.map((item, i) => (
//             <Reveal key={i} variants={moveUpV2} delayRange={i * 0.06}>
//               <div className="rounded-[10px] bg-primary/20 border border-primary/20 px-5 md:px-30 py-[13px] md:py-[25px] max-h-[80px]">
